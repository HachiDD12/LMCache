...
class BlendServer:
    def __init__(self, model: str, use_disk: bool = False, blend_special_str: str = " # # ", log_file: str = "chat_requests.json", blend_granularity: str = "chunk"):
        self.model = model
    ...
    async def handle_chat_completion(self, request: ChatCompletionRequest) -> ChatCompletionResponse:
        ...
        try:
            ...
            # version-specific generate syntax
            # outputs = self.llm.generate(
            #     prompt_token_ids=prompt_tokens, 
            #     sampling_params=sampling_params,
            # )
            # this works for vllm 0.10.2
            outputs = self.llm.generate(
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="chunk",
        choices=["msg", "chunk"],
        help="Blend granularity: 'msg' for message-level blending, 'chunk' for chunk-level blending (default: chunk)"
    )
    parser.add_argument(
        "--log-file",
